...
export class Gallery {
    ...
    async shareAll() {
        console.log('shareAll başlatıldı');
        try {
            ...
            // Ham hatayı direkt logla
            console.error('Paylaşım ham hatası:', error);
    ...
    async shareSingle() {
        try {
            ...
            const file = new File([blob], `${photo.name}.jpg`, { type: 'image/jpeg' });
